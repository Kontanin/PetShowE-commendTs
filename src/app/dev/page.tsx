...
function Dev() {
  return (
    <div className=" bg-gray-100 text-center ">
      <h1 className="text-4xl font-bold text-start text-gray-700 py-3">
        About Dev
      </h1>
      ...
      <h2 className="text-lg mb-4">
        Welcome to my website. I&apos;m Konatnin, a software developer.
      </h2>
      <h1 className=" flex justify-starttext-2xl font-bold my-2">
        My Experience{' '}
      </h1>
      ...
      <div className="grid grid-cols-4 my-20">
        ...
        <Image
          src="/profile/crystal-reports.png"
          alt="Crystal Reports"
          width={200}
          height={200}
        />
      ...
      <h2>with experience in IoT applications, APIs, and data management.</h2>
      <h2>
        Additionally, I also specialize in both frontend and backend development
        for websites.
      </h2>
